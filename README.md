...
- "Ver cadastros atualizados": lista os candidatos que enviaram telefone/cidade pelo autocadastro público e as solicitações de alteração na lista, cada uma com botão próprio para exportar em CSV
